...
require("../../common/manifest.js");
require("../../common/vendor.js");
global.webpackJsonp([5],[,,,,,,,,,,function(t,e,a){"use strict";var s=l(a(1)),i=l(a(11));function l(t){return t&&t.__esModule?t:{default:t}}Page((0,s.default)(i.default))},function(t,e,a){"use strict";Object.defineProperty(e,"__esModule",{value:!0});var s=a(13),i=a.n(s),l=a(14);var n=function(t){a(12)},u=a(0)(i.a,l.a,n,null,null);e.default=u.exports},function(t,e){},function(t,e,a){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0}),e.default={data:function(){return{}},onLoad:function(){t.setNavigationBarTitle({title:""})},methods:{login:function(e){console.log("得到账号:"+e.detail.value.nameValue+";得到密码:"+e.detail.value.passwordValue),t.reLaunch({url:"../tag/tag"})},register:function(){console.log("前往注册页面")}}}}).call(e,a(2).default)},function(t,e,a){"use strict";var s={render:function(){var t=this.$createElement,e=this._self._c||t;return e("form",{staticClass:"loginView",attrs:{eventid:"pqj-1"},on:{submit:this.login}},[e("view",{staticClass:"input-view"},[e("view",{staticClass:"label-view"},[e("text",{staticClass:"label"},[this._v("账号 ")])]),e("input",{staticClass:"input",attrs:{type:"text",placeholder:"请输入用户名",name:"nameValue"}})]),e("view",{staticClass:"input-view"},[e("view",{staticClass:"label-view"},[e("text",{staticClass:"label"},[this._v("密码")])]),e("input",{staticClass:"input",attrs:{type:"password",placeholder:"请输入密码",name:"passwordValue"}})]),e("view",{staticClass:"button-view"},[e("button",{staticClass:"login",attrs:{type:"default","hover-class":"hover",formType:"submit"}},[this._v("登录")]),e("button",{staticClass:"register",attrs:{type:"default","hover-class":"hover",eventid:"IN8-0"},on:{click:this.register}},[this._v("免费注册")])],1)])},staticRenderFns:[]};e.a=s}],[10]);
});
...
require("../../common/manifest.js");
require("../../common/vendor.js");
global.webpackJsonp([4],{15:function(e,t,i){"use strict";var s=a(i(1)),n=a(i(16));function a(e){return e&&e.__esModule?e:{default:e}}Page((0,s.default)(n.default))},16:function(e,t,i){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var s=i(18),n=i.n(s),a=i(19);var o=function(e){i(17)},r=i(0)(n.a,a.a,o,null,null);t.default=r.exports},17:function(e,t){},18:function(e,t,i){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default={data:function(){return{refreshing:!1,providerList:[],list:[],fetchPageNum:1}},onLoad:function(){var t=this;this.getData(),e.getProvider({service:"share",success:function(e){for(var i=[],s=0;s<e.provider.length;s++)switch(e.provider[s]){case"weixin":i.push({name:"分享到微信好友",id:"weixin"}),i.push({name:"分享到微信朋友圈",id:"weixin",type:"WXSenceTimeline"});break;case"qq":i.push({name:"分享到QQ",id:"qq"})}t.providerList=i},fail:function(e){console.log("获取登录通道失败",e)}})},onReachBottom:function(){console.log("滑动到页面底部"),this.getData()},onPullDownRefresh:function(){console.log("下拉刷新"),this.refreshing=!0,this.getData()},methods:{getData:function(){var t=this;e.request({url:this.$serverUrl+"/api/picture/posts.php?page="+(this.refreshing?1:this.fetchPageNum)+"&per_page=5",success:function(i){if(console.log("data",i),200!==i.statusCode)console.log("失败!");else{if(t.refreshing&&i.data[0].id===t.list[0].id)return e.showToast({title:"已经最新",icon:"none"}),t.refreshing=!1,void e.stopPullDownRefresh();t.refreshing?(t.refreshing=!1,e.stopPullDownRefresh(),t.list=i.data,t.fetchPageNum=2):(t.list=t.list.concat(i.data),t.fetchPageNum+=1)}}})},goDetail:function(t){e.navigateTo({url:"../detail/detail?data="+encodeURIComponent(JSON.stringify(t))})},share:function(t){var i=this;if(0!==this.providerList.length){var s=this.providerList.map(function(e){return e.name});e.showActionSheet({itemList:s,success:function(s){e.share({provider:i.providerList[s.tapIndex].id,scene:i.providerList[s.tapIndex].type&&"WXSenceTimeline"===i.providerList[s.tapIndex].type?"WXSenceTimeline":"WXSceneSession",type:0,title:"uni-app模版",summary:t.title,imageUrl:t.img_src,href:"https://uniapp.dcloud.io",success:function(e){console.log("success:"+JSON.stringify(e))},fail:function(t){e.showModal({content:t.errMsg,showCancel:!1})}})}})}else e.showModal({title:"当前环境无分享渠道!",showCancel:!1})}}}}).call(t,i(2).default)},19:function(e,t,i){"use strict";var s={render:function(){var e=this,t=e.$createElement,i=e._self._c||t;return i("view",{staticClass:"index"},[e._l(e.list,function(t,s){return i("block",{key:s},[i("view",{staticClass:"card",attrs:{eventid:"vlZ-1-"+s},on:{click:function(i){e.goDetail(t)}}},[i("image",{staticClass:"card-img",attrs:{src:t.img_src,mode:"aspectFill"}}),i("text",{staticClass:"card-num-view"},[e._v(e._s(t.img_num)+"P")]),i("view",{staticClass:"card-bottm row"},[i("view",{staticClass:"car-title-view row"},[i("text",{staticClass:"card-title"},[e._v(e._s(t.title))])]),i("view",{staticClass:"card-share-view",attrs:{eventid:"CQH-0-"+s},on:{click:function(i){i.stopPropagation(),e.share(t)}}})])])])}),i("text",{staticClass:"loadMore"},[e._v("加载中...")])],2)},staticRenderFns:[]};t.a=s}},[15]);
});
...
require("../../common/manifest.js");
require("../../common/vendor.js");
global.webpackJsonp([7],{20:function(e,t,i){"use strict";var s=o(i(1)),n=o(i(21));function o(e){return e&&e.__esModule?e:{default:e}}Page((0,s.default)(n.default))},21:function(e,t,i){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var s=i(23),n=i.n(s),o=i(24);var r=function(e){i(22)},a=i(0)(n.a,o.a,r,null,null);t.default=a.exports},22:function(e,t){},23:function(e,t,i){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default={data:function(){return{refreshing:!1,lists:[],fetchPageNum:1}},onLoad:function(){var t=this;this.getData(),e.getProvider({service:"share",success:function(e){for(var i=[],s=0;s<e.provider.length;s++)switch(e.provider[s]){case"weixin":i.push({name:"分享到微信好友",id:"weixin"}),i.push({name:"分享到微信朋友圈",id:"weixin",type:"WXSenceTimeline"});break;case"qq":i.push({name:"分享到QQ",id:"qq"})}t.providerList=i},fail:function(e){console.log("获取登录通道失败",e)}})},onPullDownRefresh:function(){console.log("下拉刷新"),this.refreshing=!0,this.getData()},onReachBottom:function(){this.getData()},methods:{getData:function(){var t=this;e.request({url:this.$serverUrl+"/api/picture/posts.php?page="+(this.refreshing?1:this.fetchPageNum)+"&per_page=10",success:function(i){if(200!==i.statusCode)console.log("请求失败:",i);else{if(t.refreshing&&i.data[0].id===t.lists[0][0].id)return e.showToast({title:"已经最新",icon:"none"}),t.refreshing=!1,void e.stopPullDownRefresh();for(var s=[],n=[],o=i.data,r=0,a=o.length;r<a;r++){Math.floor(r/2);s.push(o[r]),r%2==1&&(n.push(s),s=[])}console.log("得到lists",n),t.refreshing?(t.refreshing=!1,e.stopPullDownRefresh(),t.lists=n,t.fetchPageNum=2):(t.lists=t.lists.concat(n),t.fetchPageNum+=1)}}})},goDetail:function(t){e.navigateTo({url:"../detail/detail?data="+encodeURIComponent(JSON.stringify(t))})},share:function(t){var i=this;if(0!==this.providerList.length){var s=this.providerList.map(function(e){return e.name});e.showActionSheet({itemList:s,success:function(s){e.share({provider:i.providerList[s.tapIndex].id,scene:i.providerList[s.tapIndex].type&&"WXSenceTimeline"===i.providerList[s.tapIndex].type?"WXSenceTimeline":"WXSceneSession",type:0,title:"uni-app模版",summary:t.title,imageUrl:t.img_src,href:"https://uniapp.dcloud.io",success:function(e){console.log("success:"+JSON.stringify(e))},fail:function(t){e.showModal({content:t.errMsg,showCancel:!1})}})}})}else e.showModal({title:"当前环境无分享渠道!",showCancel:!1})}}}}).call(t,i(2).default)},24:function(e,t,i){"use strict";var s={render:function(){this.$createElement;this._self._c;return this._m(0)},staticRenderFns:[function(){var e=this.$createElement,t=this._self._c||e;return t("view",{staticClass:"index"},[t("text",{staticClass:"loadMore"},[this._v("我是购物车")])])}]};t.a=s}},[20]);
});
...
require("../../common/manifest.js");
require("../../common/vendor.js");
global.webpackJsonp([3],{30:function(t,i,e){"use strict";var a=c(e(1)),s=c(e(31));function c(t){return t&&t.__esModule?t:{default:t}}Page((0,a.default)(s.default))},31:function(t,i,e){"use strict";Object.defineProperty(i,"__esModule",{value:!0});var a=e(33),s=e.n(a),c=e(34);var l=function(t){e(32)},r=e(0)(s.a,c.a,l,null,null);i.default=r.exports},32:function(t,i){},33:function(t,i,e){"use strict";(function(t){Object.defineProperty(i,"__esModule",{value:!0}),i.default={data:function(){return{data:[{type:"分类",id:1,icon:"../../static/home/grid_1.jpg"},{type:"优惠",id:2,icon:"../../static/home/grid_2.jpg"},{type:"个人",id:3,icon:"../../static/home/grid_3.jpg"},{type:"理财",id:4,icon:"../../static/home/grid_4.jpg"}],lb_data:[{img:"../../static/home/shuffling_1.jpg"},{img:"../../static/home/shuffling_2.jpg"},{img:"../../static/home/shuffling_3.jpg"}],interval:5e3,duration:1e3,lb_data_text:["[特惠]洋河年末大促，低至两件五折","[公告]华北、华中部分地区配送延迟","[特惠]家电狂欢千亿礼券 买1送1！"]}},methods:{goList:function(i){t.navigateTo({url:"../list/list?type="+i.type+"&id="+i.id})},canvasIdErrorCallback:function(t){console.error(t.detail.errMsg)}}}}).call(i,e(2).default)},34:function(t,i,e){"use strict";var a={render:function(){var t=this,i=t.$createElement,e=t._self._c||i;return e("view",{staticClass:"tag_index"},[e("swiper",{staticStyle:{width:"100%"},attrs:{"indicator-dots":!0,autoplay:!0,interval:t.interval,duration:t.duration,circular:!0}},t._l(t.lb_data,function(t,i){return e("swiper-item",{key:i,attrs:{mpcomid:"Oo7-0-"+i}},[e("image",{staticClass:"lb-img",staticStyle:{width:"100%",height:"100%"},attrs:{src:t.img}})])})),e("view",{staticClass:"tags"},t._l(t.data,function(i,a){return e("block",{key:a},[e("view",{staticClass:"tag-oneview",style:{flexBasis:"25%"},attrs:{eventid:"oJV-0-"+a},on:{tap:function(e){t.goList(i)}}},[e("view",{staticClass:"tag"},[e("image",{staticClass:"tag-img",attrs:{src:i.icon}}),e("text",{staticClass:"tag-text"},[t._v(t._s(i.type))])])])])})),e("view",{staticStyle:{flex:"1",height:"6upx",width:"100%","background-color":"#EFEFEF"}}),e("view",{staticStyle:{flex:"1",width:"100%","background-color":"#FFFFFF"}},[e("view",{staticClass:"tag-input-view"},[t._m(0),e("swiper",{staticStyle:{width:"100%",height:"60upx"},attrs:{"indicator-dots":!1,vertical:!0,autoplay:!0,interval:t.interval,duration:t.duration,circular:!0}},t._l(t.lb_data_text,function(i,a){return e("swiper-item",{key:a,attrs:{mpcomid:"ksG-1-"+a}},[e("text",{staticClass:"tag-label",staticStyle:{color:"#000000","font-size":"28upx"}},[t._v(t._s(i))])])}))],1)]),e("view",{staticStyle:{flex:"1",height:"6upx",width:"100%","background-color":"#EFEFEF"}}),t._m(1)],1)},staticRenderFns:[function(){var t=this.$createElement,i=this._self._c||t;return i("view",{staticClass:"tag-label-view"},[i("text",{staticClass:"tag-label"},[this._v("商城头条")])])},function(){var t=this.$createElement,i=this._self._c||t;return i("view",{staticClass:"tags",staticStyle:{"background-color":"#EFEFEF"}},[i("view",{staticClass:"tag-oneview",staticStyle:{width:"100%",height:"300upx","background-color":"#FFFFFF"}}),i("view",{staticStyle:{height:"6upx",width:"100%","background-color":"#EFEFEF"}}),i("view",{staticClass:"tag-oneview",staticStyle:{width:"49.7%",height:"300upx","background-color":"#FFFFFF"}}),i("view",{staticClass:"tag-oneview",staticStyle:{width:"49.7%","margin-left":"0.6%",height:"300upx","background-color":"#FFFFFF"}}),i("view",{staticStyle:{height:"6upx",width:"100%","background-color":"#EFEFEF"}}),i("view",{staticClass:"tag-oneview",staticStyle:{width:"49.7%",height:"300upx","background-color":"#FFFFFF"}}),i("view",{staticClass:"tag-oneview",staticStyle:{width:"49.7%","margin-left":"0.6%",height:"300upx","background-color":"#FFFFFF"}})])}]};i.a=a}},[30]);
});
...
require("../../common/manifest.js");
require("../../common/vendor.js");
global.webpackJsonp([6],{35:function(e,t,i){"use strict";var s=a(i(1)),n=a(i(36));function a(e){return e&&e.__esModule?e:{default:e}}Page((0,s.default)(n.default))},36:function(e,t,i){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var s=i(38),n=i.n(s),a=i(39);var o=function(e){i(37)},r=i(0)(n.a,a.a,o,null,null);t.default=r.exports},37:function(e,t){},38:function(e,t,i){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default={data:function(){return{refreshing:!1,loadMoreText:"加载中...",lists:[],id:0,fetchPageNum:0}},onLoad:function(t){var i=this;e.setNavigationBarTitle({title:"专题："+t.type}),this.id=t.id,setTimeout(function(){i.getData()},300),e.getProvider({service:"share",success:function(e){for(var t=[],s=0;s<e.provider.length;s++)switch(e.provider[s]){case"weixin":t.push({name:"分享到微信好友",id:"weixin"}),t.push({name:"分享到微信朋友圈",id:"weixin",type:"WXSenceTimeline"});break;case"qq":t.push({name:"分享到QQ",id:"qq"})}i.providerList=t},fail:function(e){console.log("获取登录通道失败",e)}})},onPullDownRefresh:function(){console.log("下拉刷新"),this.refreshing=!0,this.getData()},onReachBottom:function(){console.log("上拉加载刷新"),this.fetchPageNum>4?this.loadMoreText="没有更多了":this.getData()},methods:{getData:function(t){var i=this;e.request({url:this.$serverUrl+"/api/picture/list.php?type="+this.id,success:function(t){if(200!==t.statusCode)console.log("请求失败",t);else{if(i.refreshing&&t.data.data[0].id===i.lists[0][0].id)return e.showToast({title:"已经最新",icon:"none"}),i.refreshing=!1,void e.stopPullDownRefresh();for(var s=[],n=[],a=t.data.data,o=0,r=a.length;o<r;o++){Math.floor(o/2);s.push(a[o]),o%2==1&&(n.push(s),s=[])}console.log("list页面得到lists",n),i.refreshing?(i.refreshing=!1,e.stopPullDownRefresh(),i.lists=n,i.fetchPageNum=2):(i.lists=i.lists.concat(n),i.fetchPageNum+=1),i.fetchPageNum+=1}}})},goDetail:function(t){e.navigateTo({url:"../detail/detail?data="+encodeURIComponent(JSON.stringify(t))})},share:function(t){var i=this;if(0!==this.providerList.length){var s=this.providerList.map(function(e){return e.name});e.showActionSheet({itemList:s,success:function(s){e.share({provider:i.providerList[s.tapIndex].id,scene:i.providerList[s.tapIndex].type&&"WXSenceTimeline"===i.providerList[s.tapIndex].type?"WXSenceTimeline":"WXSceneSession",type:0,title:"uni-app模版",summary:t.title,imageUrl:t.img_src,href:"https://uniapp.dcloud.io",success:function(e){console.log("success:"+JSON.stringify(e))},fail:function(t){e.showModal({content:t.errMsg,showCancel:!1})}})}})}else e.showModal({title:"当前环境无分享渠道!",showCancel:!1})}}}}).call(t,i(2).default)},39:function(e,t,i){"use strict";var s={render:function(){var e=this,t=e.$createElement,i=e._self._c||t;return i("view",{staticClass:"index"},[e._l(e.lists,function(t,s){return i("block",{key:s},[i("view",{staticClass:"row"},e._l(t,function(t,n){return i("view",{key:n,staticClass:"card card-list2",attrs:{eventid:"Rse-1-"+s+"-"+n},on:{click:function(i){e.goDetail(t)}}},[i("image",{staticClass:"card-img card-list2-img",attrs:{src:t.img_src}}),i("text",{staticClass:"card-num-view card-list2-num-view"},[e._v(e._s(t.img_num)+"P")]),i("view",{staticClass:"card-bottm row"},[i("view",{staticClass:"car-title-view row"},[i("text",{staticClass:"card-title card-list2-title"},[e._v(e._s(t.title))])]),i("view",{staticClass:"card-share-view",attrs:{eventid:"2yO-0-"+s+"-"+n},on:{click:function(i){i.stopPropagation(),e.share(t)}}})])])}))])}),i("text",{staticClass:"loadMore"},[e._v(e._s(e.loadMoreText))])],2)},staticRenderFns:[]};t.a=s}},[35]);
});
...
require("../../common/manifest.js");
require("../../common/vendor.js");
global.webpackJsonp([2],{40:function(e,t,n){"use strict";var s=i(n(1)),a=i(n(41));function i(e){return e&&e.__esModule?e:{default:e}}Page((0,s.default)(a.default))},41:function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var s=n(43),a=n.n(s),i=n(44);var r=function(e){n(42)},o=n(0)(a.a,i.a,r,null,null);t.default=o.exports},42:function(e,t){},43:function(e,t,n){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default={data:function(){return{isH5Plus:!0,userinfo:{},orderTypeLise:[{name:"待付款",icon:"l1.png",badge:1},{name:"待发货",icon:"l2.png",badge:2},{name:"待收货",icon:"l3.png",badge:6},{name:"待评价",icon:"l4.png",badge:9},{name:"退换货",icon:"l5.png",badge:0}],severList:[[{name:"我的收藏",icon:"point.png"},{name:"优惠券",icon:"quan.png"},{name:"红包",icon:"momey.png"},{name:"任务",icon:"renw.png"}],[{name:"积分明细",icon:"mingxi.png"},{name:"抽奖",icon:"choujiang.png"},{name:"收货地址",icon:"addr.png"},{name:"银行卡",icon:"bank.png"},{name:"安全中心",icon:"security.png"},{name:"在线客服",icon:"kefu.png"}]]}},onLoad:function(){this.init()},methods:{init:function(){this.userinfo={face:"../../static/HM-PersonalCenter/face.jpeg",username:"VIP会员10240",integral:"1435"}},toOrderType:function(t){e.showToast({title:this.orderTypeLise[t].name})},toPage:function(t,n){e.showToast({title:this.severList[t][n].name})}}}}).call(t,n(2).default)},44:function(e,t,n){"use strict";var s={render:function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("view",[n("view",{staticClass:"header",class:{status:e.isH5Plus}},[n("view",{staticClass:"userinfo"},[n("view",{staticClass:"face"},[n("image",{attrs:{src:e.userinfo.face}})]),n("view",{staticClass:"info"},[n("view",{staticClass:"username"},[e._v(e._s(e.userinfo.username))]),n("view",{staticClass:"integral"},[e._v("积分:"+e._s(e.userinfo.integral))])])]),e._m(0)]),n("view",{staticClass:"orders"},[n("view",{staticClass:"box"},e._l(e.orderTypeLise,function(t,s){return n("view",{staticClass:"label",attrs:{"wx:key":"row.name","hover-class":"hover","hover-stay-time":"50",eventid:"2Gx-0-"+s},on:{tap:function(t){e.toOrderType(s)}}},[n("view",{staticClass:"icon"},[t.badge>0?n("view",{staticClass:"badge"},[e._v(e._s(t.badge))]):e._e(),n("image",{attrs:{src:"../../static/HM-PersonalCenter/"+t.icon}})]),e._v("\n\t\t\t\t"+e._s(t.name)+"\n\t\t\t")])}))]),e._l(e.severList,function(t,s){return n("view",{staticClass:"list",attrs:{"wx:key":"list"}},e._l(t,function(a,i){return n("view",{staticClass:"li",class:{noborder:i==t.length-1},attrs:{"hover-class":"hover","hover-stay-time":"50","wx:key":"li.name",eventid:"a90-1-"+s+"-"+i},on:{tap:function(t){e.toPage(s,i)}}},[n("view",{staticClass:"icon"},[n("image",{attrs:{src:"../../static/HM-PersonalCenter/sever/"+a.icon}})]),n("view",{staticClass:"text"},[e._v(e._s(a.name))]),n("image",{staticClass:"to",attrs:{src:"../../static/HM-PersonalCenter/to.png"}})])}))})],2)},staticRenderFns:[function(){var e=this.$createElement,t=this._self._c||e;return t("view",{staticClass:"setting"},[t("image",{attrs:{src:"../../static/HM-PersonalCenter/setting.png"}})])}]};t.a=s}},[40]);
});
...
require("../../../common/manifest.js");
require("../../../common/vendor.js");
global.webpackJsonp([1],{45:function(e,t,i){"use strict";var n=a(i(1)),s=a(i(46));function a(e){return e&&e.__esModule?e:{default:e}}Page((0,n.default)(s.default))},46:function(e,t,i){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=i(48),s=i.n(n),a=i(49);var c=function(e){i(47)},o=i(0)(s.a,a.a,c,null,null);t.default=o.exports},47:function(e,t){},48:function(e,t,i){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default={data:function(){return{providerList:[],version:"",sourceLink:"https://github.com/dcloudio/uni-template-picture"}},onLoad:function(){var t=this;this.version=plus.runtime.version,e.getProvider({service:"share",success:function(e){for(var i=[],n=0;n<e.provider.length;n++)switch(e.provider[n]){case"weixin":i.push({name:"分享到微信好友",id:"weixin"}),i.push({name:"分享到微信朋友圈",id:"weixin",type:"WXSenceTimeline"});break;case"qq":i.push({name:"分享到QQ",id:"qq"})}t.providerList=i},fail:function(e){console.log("获取登录通道失败"+JSON.stringify(e))}})},methods:{save:function(){e.showActionSheet({itemList:["保存图片到相册"],success:function(){plus.gallery.save("https://img.cdn.aliyun.dcloud.net.cn/guide/uniapp/app_download.png",function(){e.showToast({title:"保存成功",icon:"none"})},function(){e.showToast({title:"保存失败，请重试！",icon:"none"})})}})},share:function(t){var i=this;if(0!==this.providerList.length){var n=this.providerList.map(function(e){return e.name});e.showActionSheet({itemList:n,success:function(t){e.share({provider:i.providerList[t.tapIndex].id,scene:i.providerList[t.tapIndex].type&&"WXSenceTimeline"===i.providerList[t.tapIndex].type?"WXSenceTimeline":"WXSceneSession",type:0,title:"欢迎体验uni-app",summary:"uni-app 是一个使用 Vue.js 开发跨平台应用的前端框架",imageUrl:"https://img-cdn-qiniu.dcloud.net.cn/uploads/nav_menu/8.jpg",href:"https://m3w.cn/uniapp",success:function(e){console.log("success:"+JSON.stringify(e))},fail:function(t){e.showModal({content:t.errMsg,showCancel:!1})}})}})}else e.showModal({title:"当前环境无分享渠道!",showCancel:!1})},openLink:function(){plus.runtime.openURL(this.sourceLink)}}}}).call(t,i(2).default)},49:function(e,t,i){"use strict";var n={render:function(){var e=this,t=e.$createElement,i=e._self._c||t;return i("view",{staticClass:"about"},[i("view",{staticClass:"content"},[i("view",{staticClass:"qrcode"},[i("image",{attrs:{src:"https://img.cdn.aliyun.dcloud.net.cn/stream/qr/__UNI__FAD3FD9.png/256",eventid:"KYm-0"},on:{longtap:e.save}}),i("text",{staticStyle:{"margin-top":"20px"}},[e._v("扫码体验看图App模板")])]),i("view",{staticClass:"desc"},[e._v("\n\t\t\t基于uni-app开发的看图App模版，项目已开源。\n\t\t")]),i("view",{staticClass:"source"},[i("view",{staticClass:"title"},[e._v("本示例源码获取方式：")]),i("view",{staticClass:"source-list"},[e._m(0),i("view",{staticClass:"source-cell"},[i("text",{attrs:{space:"nbsp"}},[e._v("2. ")]),i("text",{staticClass:"link",attrs:{eventid:"m2m-1"},on:{click:e.openLink}},[e._v(e._s(e.sourceLink))])])])]),i("button",{attrs:{type:"primary",eventid:"JjE-2"},on:{click:e.share}},[e._v("分享")])],1),i("view",{staticClass:"version"},[e._v("\n\t\t当前版本："+e._s(e.version)+"\n\t")])])},staticRenderFns:[function(){var e=this.$createElement,t=this._self._c||e;return t("view",{staticClass:"source-cell"},[t("text",{attrs:{space:"nbsp"}},[this._v("1. ")]),t("text",[this._v("下载 HBuilderX，新建 uni-app 项目时选择 看图App 模板。")])])}]};t.a=n}},[45]);
});
...
require("../../../common/manifest.js");
require("../../../common/vendor.js");
global.webpackJsonp([9],{50:function(t,e,n){"use strict";var a=s(n(1)),i=s(n(51));function s(t){return t&&t.__esModule?t:{default:t}}Page((0,a.default)(i.default))},51:function(t,e,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0});var a=n(53),i=n.n(a),s=n(54);var r=function(t){n(52)},c=n(0)(i.a,s.a,r,null,null);e.default=c.exports},52:function(t,e){},53:function(t,e,n){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0});e.default={data:function(){return{banner:{},content:""}},onShareAppMessage:function(){return{title:this.banner.title,path:"/pages/detail/detail?query="+JSON.stringify(this.banner)}},onLoad:function(e){try{this.banner=JSON.parse(decodeURIComponent(e.query))}catch(t){this.banner=JSON.parse(e.query)}this.getDetail(),t.setNavigationBarTitle({title:this.banner.title})},methods:{getDetail:function(){var e=this;t.request({url:"https://unidemo.dcloud.net.cn/api/news/36kr/"+this.banner.post_id,success:function(t){200==t.statusCode?e.content=t.data.content:e.content="<p>获取信息失败</p>"}})}}}}).call(e,n(2).default)},54:function(t,e,n){"use strict";var a={render:function(){var t=this,e=t.$createElement,n=t._self._c||e;return n("view",[n("view",{staticClass:"banner"},[n("image",{staticClass:"banner-img",attrs:{src:t.banner.image_url}}),n("view",{staticClass:"banner-title"},[t._v(t._s(t.banner.title))])]),n("view",{staticClass:"article-meta"},[n("text",{staticClass:"article-author"},[t._v(t._s(t.banner.source))]),n("text",{staticClass:"article-text"},[t._v("发表于")]),n("text",{staticClass:"article-time"},[t._v(t._s(t.banner.datetime))])]),n("view",{staticClass:"article-content"},[n("rich-text",{attrs:{nodes:t.content,mpcomid:"Ail-0"}})],1)])},staticRenderFns:[]};e.a=a}},[50]);
});

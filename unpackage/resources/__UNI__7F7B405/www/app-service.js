...
require("../../common/manifest.js");
require("../../common/vendor.js");
global.webpackJsonp([6],{20:function(e,t,i){"use strict";var s=a(i(1)),n=a(i(21));function a(e){return e&&e.__esModule?e:{default:e}}Page((0,s.default)(n.default))},21:function(e,t,i){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var s=i(23),n=i.n(s),a=i(24);var r=function(e){i(22)},o=i(0)(n.a,a.a,r,null,null);t.default=o.exports},22:function(e,t){},23:function(e,t,i){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default={data:function(){return{refreshing:!1,lists:[],fetchPageNum:1}},onLoad:function(){var t=this;this.getData(),e.getProvider({service:"share",success:function(e){for(var i=[],s=0;s<e.provider.length;s++)switch(e.provider[s]){case"weixin":i.push({name:"分享到微信好友",id:"weixin"}),i.push({name:"分享到微信朋友圈",id:"weixin",type:"WXSenceTimeline"});break;case"qq":i.push({name:"分享到QQ",id:"qq"})}t.providerList=i},fail:function(e){console.log("获取登录通道失败",e)}})},onPullDownRefresh:function(){console.log("下拉刷新"),this.refreshing=!0,this.getData()},onReachBottom:function(){this.getData()},methods:{getData:function(){var t=this;e.request({url:this.$serverUrl+"/api/picture/posts.php?page="+(this.refreshing?1:this.fetchPageNum)+"&per_page=10",success:function(i){if(200!==i.statusCode)console.log("请求失败:",i);else{if(t.refreshing&&i.data[0].id===t.lists[0][0].id)return e.showToast({title:"已经最新",icon:"none"}),t.refreshing=!1,void e.stopPullDownRefresh();for(var s=[],n=[],a=i.data,r=0,o=a.length;r<o;r++){Math.floor(r/2);s.push(a[r]),r%2==1&&(n.push(s),s=[])}console.log("得到lists",n),t.refreshing?(t.refreshing=!1,e.stopPullDownRefresh(),t.lists=n,t.fetchPageNum=2):(t.lists=t.lists.concat(n),t.fetchPageNum+=1)}}})},goDetail:function(t){e.navigateTo({url:"../detail/detail?data="+encodeURIComponent(JSON.stringify(t))})},share:function(t){var i=this;if(0!==this.providerList.length){var s=this.providerList.map(function(e){return e.name});e.showActionSheet({itemList:s,success:function(s){e.share({provider:i.providerList[s.tapIndex].id,scene:i.providerList[s.tapIndex].type&&"WXSenceTimeline"===i.providerList[s.tapIndex].type?"WXSenceTimeline":"WXSceneSession",type:0,title:"uni-app模版",summary:t.title,imageUrl:t.img_src,href:"https://uniapp.dcloud.io",success:function(e){console.log("success:"+JSON.stringify(e))},fail:function(t){e.showModal({content:t.errMsg,showCancel:!1})}})}})}else e.showModal({title:"当前环境无分享渠道!",showCancel:!1})}}}}).call(t,i(2).default)},24:function(e,t,i){"use strict";var s={render:function(){var e=this,t=e.$createElement,i=e._self._c||t;return i("view",{staticClass:"index"},[e._l(e.lists,function(t,s){return i("block",{key:s},[i("view",{staticClass:"row"},e._l(t,function(t,n){return i("view",{key:n,staticClass:"card card-list2",attrs:{eventid:"eFQ-1-"+s+"-"+n},on:{click:function(i){e.goDetail(t)}}},[i("image",{staticClass:"card-img card-list2-img",attrs:{src:t.img_src}}),i("text",{staticClass:"card-num-view card-list2-num-view"},[e._v(e._s(t.img_num)+"P")]),i("view",{staticClass:"card-bottm row"},[i("view",{staticClass:"car-title-view row"},[i("text",{staticClass:"card-title card-list2-title"},[e._v(e._s(t.title))])]),i("view",{staticClass:"card-share-view",attrs:{eventid:"5Y2-0-"+s+"-"+n},on:{click:function(i){i.stopPropagation(),e.share(t)}}})])])}))])}),i("text",{staticClass:"loadMore"},[e._v("加载中...")])],2)},staticRenderFns:[]};t.a=s}},[20]);
});
...
require("../../common/manifest.js");
require("../../common/vendor.js");
global.webpackJsonp([2],{30:function(t,i,a){"use strict";var e=l(a(1)),n=l(a(31));function l(t){return t&&t.__esModule?t:{default:t}}Page((0,e.default)(n.default))},31:function(t,i,a){"use strict";Object.defineProperty(i,"__esModule",{value:!0});var e=a(33),n=a.n(e),l=a(34);var o=function(t){a(32)},c=a(0)(n.a,l.a,o,null,null);i.default=c.exports},32:function(t,i){},33:function(t,i,a){"use strict";(function(t){Object.defineProperty(i,"__esModule",{value:!0}),i.default={data:function(){return{data:[{type:"动物",id:1,icon:"http://placehold.it/150x150"},{type:"风景",id:2,icon:"http://placehold.it/150x150"},{type:"建筑",id:3,icon:"http://placehold.it/150x150"},{type:"美女",id:4,icon:"http://placehold.it/150x150"},{type:"汽车",id:5,icon:"http://placehold.it/150x150"},{type:"运动",id:6,icon:"http://placehold.it/150x150"},{type:"动物",id:1,icon:"http://placehold.it/150x150"},{type:"风景",id:2,icon:"http://placehold.it/150x150"}],lb_data:[{img:"../../static/home/shuffling_1.jpg"},{img:"../../static/home/shuffling_2.jpg"},{img:"../../static/home/shuffling_3.jpg"}],indicatorDots:!0,autoplay:!0,interval:5e3,duration:1e3}},methods:{goList:function(i){t.navigateTo({url:"../list/list?type="+i.type+"&id="+i.id})},canvasIdErrorCallback:function(t){console.error(t.detail.errMsg)}}}}).call(i,a(2).default)},34:function(t,i,a){"use strict";var e={render:function(){var t=this,i=t.$createElement,a=t._self._c||i;return a("view",{staticClass:"index"},[a("swiper",{staticStyle:{width:"100%"},attrs:{"indicator-dots":t.indicatorDots,autoplay:t.autoplay,interval:t.interval,duration:t.duration,circular:!0}},t._l(t.lb_data,function(t,i){return a("swiper-item",{key:i,attrs:{mpcomid:"5Za-0-"+i}},[a("image",{staticClass:"lb-img",attrs:{src:t.img}})])})),a("view",{staticClass:"tags"},t._l(t.data,function(i,e){return a("block",{key:e},[a("view",{staticClass:"tag",attrs:{eventid:"8Db-0-"+e},on:{tap:function(a){t.goList(i)}}},[a("image",{staticClass:"tag-img",attrs:{src:i.icon}}),a("text",{staticClass:"tag-text"},[t._v(t._s(i.type))])])])}))],1)},staticRenderFns:[]};i.a=e}},[30]);
});
...
require("../../common/manifest.js");
require("../../common/vendor.js");
global.webpackJsonp([8],{40:function(t,s,i){"use strict";var e=l(i(1)),a=l(i(41));function l(t){return t&&t.__esModule?t:{default:t}}Page((0,e.default)(a.default))},41:function(t,s,i){"use strict";Object.defineProperty(s,"__esModule",{value:!0});var e=i(43),a=i.n(e),l=i(44);var n=function(t){i(42)},c=i(0)(a.a,l.a,n,null,null);s.default=c.exports},42:function(t,s){},43:function(t,s,i){"use strict";(function(t){Object.defineProperty(s,"__esModule",{value:!0}),s.default={data:function(){return{login:!1,avatarUrl:"../../static/logo.png",uerInfo:{}}},methods:{goLogin:function(){this.login||t.navigateTo({url:"../login/login"})},goAbout:function(){t.navigateTo({url:"/platforms/app-plus/about/about"})}}}}).call(s,i(2).default)},44:function(t,s,i){"use strict";var e={render:function(){var t=this,s=t.$createElement,i=t._self._c||s;return i("view",{staticClass:"center"},[i("view",{staticClass:"logo",attrs:{"hover-class":t.login?"":"logo-hover",eventid:"Jxq-0"},on:{click:t.goLogin}},[i("image",{staticClass:"logo-img",attrs:{src:t.login?t.uerInfo.avatarUrl:t.avatarUrl}}),i("view",{staticClass:"logo-title"},[i("text",{staticClass:"uer-name"},[t._v("Hi，"+t._s(t.login?t.uerInfo.name:"您未登录"))]),t.login?t._e():i("text",{staticClass:"go-login navigat-arrow"},[t._v("")])])]),t._m(0),t._m(1),i("view",{staticClass:"center-list"},[i("view",{staticClass:"center-list-item border-bottom",attrs:{eventid:"oh0-1"},on:{click:t.goAbout}},[i("text",{staticClass:"list-icon"},[t._v("")]),i("text",{staticClass:"list-text"},[t._v("关于")]),i("text",{staticClass:"navigat-arrow"},[t._v("")])]),t._m(2)])])},staticRenderFns:[function(){var t=this.$createElement,s=this._self._c||t;return s("view",{staticClass:"center-list"},[s("view",{staticClass:"center-list-item border-bottom"},[s("text",{staticClass:"list-icon"},[this._v("")]),s("text",{staticClass:"list-text"},[this._v("收藏图片")]),s("text",{staticClass:"navigat-arrow"},[this._v("")])]),s("view",{staticClass:"center-list-item"},[s("text",{staticClass:"list-icon"},[this._v("")]),s("text",{staticClass:"list-text"},[this._v("收藏图集")]),s("text",{staticClass:"navigat-arrow"},[this._v("")])])])},function(){var t=this.$createElement,s=this._self._c||t;return s("view",{staticClass:"center-list"},[s("view",{staticClass:"center-list-item border-bottom"},[s("text",{staticClass:"list-icon"},[this._v("")]),s("text",{staticClass:"list-text"},[this._v("管理图片")]),s("text",{staticClass:"navigat-arrow"},[this._v("")])]),s("view",{staticClass:"center-list-item"},[s("text",{staticClass:"list-icon"},[this._v("")]),s("text",{staticClass:"list-text"},[this._v("上传图片")]),s("text",{staticClass:"navigat-arrow"},[this._v("")])])])},function(){var t=this.$createElement,s=this._self._c||t;return s("view",{staticClass:"center-list-item"},[s("text",{staticClass:"list-icon"},[this._v("")]),s("text",{staticClass:"list-text"},[this._v("帐号管理")]),s("text",{staticClass:"navigat-arrow"},[this._v("")])])}]};s.a=e}},[40]);
});
